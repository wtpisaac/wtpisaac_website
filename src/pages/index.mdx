...
import imageOfIsaac from '../images/isaac_vancouver_nature.jpg'

_email: [my username] @ gmail_

<Image src={imageOfIsaac} alt="it's me :)" height="448" width="336" />

Software developer and FOSS enthusiast in San Diego, CA, USA.

Currently self-employed, working on contract for Marriott International and mroads llc, contributing to Marriott's
GraphQL efforts on their UXL team.

# Links
- [Portfolio Website (you are here)](https://wtpisaac.com/)
- [LinkedIn](https://www.linkedin.com/in/wtpisaac/)
- [GitHub](https://github.com/wtpisaac)
- [Codeberg](https://codeberg.org/wtpisaac)

As of 2024, I do not have social media on Instagram, Facebook, X, Mastodon, or similar platforms. I find social media to
be unconscionable to support, and frankly, a generally unpleasant experience.

I am intending to migrate from GitHub to Codeberg for any future projects.

I am working on a personal website for less-than-professional posts and content, hopefully sooner than later.

# Current Projects

## insprng (iOS)
insprng is a motivational quotes app for iOS; you may obtain it free of charge from the App Store.
...
[Download](https://apps.apple.com/us/app/insprng-inspiring-quotes/id1640221466)
...
I created two small games for a game design course at UCSC.

### Violet (Twine) [AGPLv3+] [[Play Now!]](/violetgame/violet.html)
